-- Script corrigido para solucionar problemas de salvamento
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM storage.buckets WHERE id = 'images') THEN
    PERFORM storage.create_bucket('images', '{"public": true, "file_size_limit": 209715200}'::jsonb);
  ELSE
    -- Atualiza o bucket existente
